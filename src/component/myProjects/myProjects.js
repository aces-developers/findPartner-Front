    ...
    return (
        <>
            ...
            <ButtonGroup size="lg" className="mb-2 switchGroupBtns">
                <Button onClick={()=> displayPublished(userPublishedProjects) } className="btn btn-primary btn-lg" >Owner</Button>
                <Button onClick={()=> displayPublished(AllAppliedID)} className="btn btn-secondary btn-lg" >Partner</Button>
            </ButtonGroup>

            
            <Table responsive hover className="dashboardTable shadow p-3 mb-5 bg-white rounded w-75 p-3 mx-auto ">
                <thead>
                    <tr>
                        <th>#</th>
